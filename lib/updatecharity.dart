...
class _UpdateCharityState extends State<UpdateCharity> {
                                            ...
                                            children: [
                                              SizedBox(
                                                ...
                                                child: RaisedButton(
                                                  color: Colors.blue[100],
                                                  child: Text(
                                                    widget.charity.startTime, //startTime
                                                    style:
                                                        TextStyle(fontSize: 14),
                                                  ),
                                                  onPressed: () async {
  ...
  void updateEvent()async{
    ...
    if (_image != null)  {
      ...
      await DefaultCacheManager().removeFile('http://yitengsze.com/a_gifhope/charityimages/${widget.charity.eid}.jpg');
    } 
